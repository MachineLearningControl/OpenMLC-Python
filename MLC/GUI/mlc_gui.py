...
from MLC.GUI.GUI_Experiments_Manager import GUI_Experiments_Manager
...
class MLC_GUI(QMainWindow):
    ...
    def load_gui_config(self):
        ...
        # Create the MLC Local instance and initialize the GUI_Experiments_Manager
        self._mlc_local = MLCLocal(workspace_dir)
        self._experiments_manager = GUI_Experiments_Manager(self._mlc_local, self._gui_config)
