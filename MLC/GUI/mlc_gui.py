...
class MLC_GUI(QMainWindow):
    ...
    def on_experiment_list_context_menu(self, point):
        ...
        self._context_menu.popup(self._autogenerated_object.experiment_list.mapToGlobal(point))
