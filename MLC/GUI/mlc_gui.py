...
class MLC_GUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.autogenerated_object = Ui_MLCManager()
    ...
    def on_open_button_clicked(self):
        logger.debug("[MLC_MANAGER] Open button clicked")
        if self.experiment_selected is None:
            logger.info("[MLC MANAGER] No experiment was selected yet. Don't do anything")
            return

        experiment = ExperimentDialog(self, self.mlc_local, self.experiment_selected)
        experiment.show()
        experiment.exec_()
    ...
    def load_gui_config(self):
        ...
        self.mlc_local = MLCLocal(workspace_dir)
