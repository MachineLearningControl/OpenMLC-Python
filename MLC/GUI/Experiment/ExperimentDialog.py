...
class ExperimentDialog(QDialog):
    ...
    def _update_experiment_info(self):
        ...
        if number_of_gens != 0:
            ...
            table_model = ConfigTableModel(self._individuals_per_generation[self._current_gen - 1], header, self)
    ...
    def _update_individuals_figure(self):
        if self._current_gen != 0:
            ...
            indiv_chart.set_yaxis(log=ylog, label="Costs", label_format='%g')
            indiv_chart.add_data(samples, costs, color=Qt.red)
    ...
    def _update_individuals_per_generation_list(self):
        ...
        for index in xrange(1, number_of_gens + 1):
            ...
            for pop_index in xrange(1, indivs_per_gen + 1):
                ...
                gens_list.append([pop_index, indiv_index + 1, indiv_cost, indiv_value, 1, indiv_appearences])
