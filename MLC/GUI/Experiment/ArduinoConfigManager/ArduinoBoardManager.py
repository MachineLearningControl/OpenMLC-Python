...
class ArduinoBoardManager:
    ...
    def start_connection(self):
        ...
        current_setup = self.__main_window.checkout_config()
        current_setup["parity"] = self.PARITY_BITS[current_setup["parity"]]
        current_setup["stopbits"] = self.STOP_BITS[current_setup["stopbits"]]
        current_setup["bytesize"] = self.BYTE_SIZE[current_setup["bytesize"]]

        return SerialConnection(**current_setup)
