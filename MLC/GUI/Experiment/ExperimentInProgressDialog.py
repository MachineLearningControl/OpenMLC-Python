...
class ExperimentInProgressDialog(QDialog):
    indiv_evaluated = pyqtSignal([int, int, int])
    ...
    def _update_dialog(self, indivs_per_gen_counter, total_indivs_counter, gen_counter):
        ...
        gen_label.setText("<b>Generation {0}/{1}</b>".format(gen_counter, self._amount_gens))
    ...
    def _simulation_finished(self):
        ...
        QMessageBox.information(self, "Experiment finished", 
                                "Experiment {0} succesfully finished.", QMessageBox.Ok)
...
class ExperimentInProgress(Thread):
    ...
    def __init__(self, mlc_local, experiment_name, to_gen, from_gen, parent=None):
        ...
        self._dialog = ExperimentInProgressDialog()
