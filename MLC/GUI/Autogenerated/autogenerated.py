...
class Ui_ExperimentWindow(object):
    ...
    def retranslateUi(self, ExperimentWindow):
        ...
        self.groupBox_3.setTitle(_translate("ExperimentWindow", "DB"))
        self.pushButton_3.setText(_translate("ExperimentWindow", "Create"))
        self.pushButton_4.setText(_translate("ExperimentWindow", "Cut"))
        self.pushButton_8.setText(_translate("ExperimentWindow", "Import"))
