...
class GenericArduinoController
{
  public:
    ...
    void add_handler(uint8_t handler_id, int (*handler)(GenericArduinoController* this_, const char*));
  ...
  private:
    ...
    int (*executor[255])(GenericArduinoController*, const char*);

    // NULL operation
    static int not_implemented(GenericArduinoController* this_, const char* data);
   
    /**
     * PROTOCOL_VERSION 0x07 0x03 X . Y
     */ 
    static int protocol_version(GenericArduinoController* this_, const char* data);

    /**
     * ANALOG_WRITE: 0x06 0x03 [PIN] [H_VALUE][L_VALUE]
     */
    static int analog_write(GenericArduinoController* this_, const char* data);

    /**
     *   ANALOG_PRECISION: 0x01 0x01 [BITS]
     */
    static int set_analog_precision(GenericArduinoController* this_, const char* data);

    /**
    *   PIN_MODE: 0x04 0x02 [PIN] [MODE]
    */
    static int set_pin_mode(GenericArduinoController* this_, const char* data);
    
    /**
    *   REPORT_MODE: 0x05 0x03 [MODE] [READ_COUNT] [READ_DELAY]
    */
    static int set_report_mode(GenericArduinoController* this_, const char* data);
    
    /**
    *   ANALOG_INPUT: 0x02 0x01 [PORT]
    */
    static int set_analog_input(GenericArduinoController* this_, const char* data);
    
    /**
    *   RESET: 0xFF
    */
    static int reset(GenericArduinoController* this_, const char* data);
    
    /**
    *   ANALOG_OUTPUT: 0x03 0x01 [PORT]
    */
    static int set_analog_output(GenericArduinoController* this_, const char* data);
    
    /**
    *   ACTUATE: 0xF0 [DATA_LEN] [PIN_A] [VALUE_PIN_A] ... [PIN_N] [VALUE_PIN_N]
    */
    static int actuate(GenericArduinoController* this_, const char* data);
