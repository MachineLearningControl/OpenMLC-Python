...
opset(1).simplificationaction{1}='newlisp=num2str(str2double(arg1)+str2double(arg2),str_format);';   %% add 2 numbers -> back in string
...
opset(2).simplificationaction{1}='newlisp=num2str(str2double(arg1)-str2double(arg2),str_format);';
...
opset(2).simplificationaction{3}='newlisp=num2str(0,str_format);';
...
opset(3).simplificationaction{1}='newlisp=num2str(str2double(arg1)*str2double(arg2),str_format);';
opset(3).simplificationcondition{2}='(1-isnan(str2double(arg1)) && str2double(arg1)==0) || (1-isnan(str2double(arg2)) && str2double(arg2)==0)';
opset(3).simplificationaction{2}='newlisp=num2str(0,str_format);';
...
opset(4).simplificationaction{1}=['newlisp=num2str(  str2double(arg1)./(max(abs(str2double(arg2)),' num2str(opset(4).protection) ').*sign(str2double(arg2))),str_format);'];
opset(4).simplificationcondition{2}='(1-isnan(str2double(arg1)) && str2double(arg1)==0) || (1-isnan(str2double(arg2)) && str2double(arg2)==0)';
opset(4).simplificationaction{2}='newlisp=num2str(0,str_format);';
...
opset(5).simplificationaction{1}='newlisp=num2str(sin(str2double(arg1)),str_format);';
...
opset(6).simplificationaction{1}='newlisp=num2str(cos(str2double(arg1)),str_format);';
...
opset(7).simplificationaction{1}=['newlisp=num2str(log(max(' num2str(opset(7).protection) ',abs(str2double(arg1)))),str_format);'];
...
opset(8).simplificationaction{1}='newlisp=num2str(exp(str2double(arg1)),str_format);';
...
opset(9).simplificationaction{1}='newlisp=num2str(tanh(str2double(arg1)),str_format);';
