...
\begin{document}
    ...
    \subsubsection{Machine Learning y Programación Genética} \label{sec:mlc_and_gp}
        ...
        individuos, llamadas poblaciones, los cuales son seleccionados en función del valor de su costo, también llamado \textit{fitness}. 
        Cada individuo tiene asociado un \textit{costo} o \textit{fitness} el cual es obtenido luego de evaluar el mismo 
        a través de una función de costo.
    ...
    \includepdf[scale=0.8,clip,trim=0cm 0cm 0cm -3cm,pages={1},pagecommand={\section{Datos Integrantes}\subsection{Ezequiel Torres Feyuk}\subsubsection{CV}}]{CVs/TorresFeyuk/CV.pdf} 
        ...
        % \includepdf[pages={1,2}]{CVs/TorresFeyuk/CV.pdf}
        \newpage
